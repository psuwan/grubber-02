...
if (empty($varget_id2edit)) {
    $processName = "addVehicleType";
    $text2Show = "เพิ่มข้อมูลประเภทรถ";
    $editAble = "";

    $sqlcmd_listVehicleType = "SELECT * FROM tbl_vehicletype WHERE 1";
    $sqlres_listVehicleType = mysqli_query($dbConn, $sqlcmd_listVehicleType);
    if ($sqlres_listVehicleType) {
        $sqlnum_listVehicleType = mysqli_num_rows($sqlres_listVehicleType);
        $vehicleTypeCode = str_pad(($sqlnum_listVehicleType + 1), 4, "0", STR_PAD_LEFT);
    }
    ...
    $processName = "editVehicleType";
    $text2Show = "แก้ไขข้อมูลประเภทรถ";
    $editAble = "readonly";

    // List suppliers
    $sqlcmd_listVehicleType = "SELECT * FROM tbl_vehicletype WHERE id=" . $varget_id2edit;
    $sqlres_listVehicleType = mysqli_query($dbConn, $sqlcmd_listVehicleType);
    if ($sqlres_listVehicleType) {
        $sqlfet_listVehicleType = mysqli_fetch_assoc($sqlres_listVehicleType);

        $vehicleTypeCode = $sqlfet_listVehicleType['vehicletype_code'];
        $vehicleTypeName = $sqlfet_listVehicleType['vehicletype_name'];
        $vehicleTypeDetails = $sqlfet_listVehicleType['vehicletype_details'];
    }
}
?>
<!DOCTYPE html>
            ...
            <div class="row">
                ...
                <div class="col-md-8 order-1 order-md-0">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="./act4VehicleType.php" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="รหัสสินค้า"
                                                   name="vehicleTypeCode" id="id4VehicleTypeCode"
                                                   value="<?= $vehicleTypeCode; ?>" <?= $editAble; ?>>
                                        </div>
                                    </div><!-- Product code -->
                                    ...
                                    <div class="col-md-6 pl-md-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="ชื่อสินค้า"
                                                   name="vehicleTypeName" id="id4VehicleTypeName"
                                                   value="<?= $vehicleTypeName; ?>" onkeyup="func2ShowName(this.value)">
                                        </div>
                                    </div><!-- Product name -->
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" cols="80" class="form-control" name="vehicleTypeDetails"
                                                      id="id4VehicleTypeDetails"
                                                      placeholder="ข้อมูลอื่นๆ"><?= $vehicleTypeDetails; ?></textarea>
                                        </div>
                                    </div>
                                </div><!-- About product -->
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <?php
                                    $cntVehicleType = 0;
                                    $sqlcmd_listVehicleType = "SELECT * FROM tbl_vehicletype WHERE 1 ORDER BY vehicletype_code ASC";
                                    $sqlres_listVehicleType = mysqli_query($dbConn, $sqlcmd_listVehicleType);

                                    if ($sqlres_listVehicleType) {
                                        while ($sqlfet_listVehicleType = mysqli_fetch_assoc($sqlres_listVehicleType)) {
                                            ?>
                                            <tr>
                                                <td><?= ++$cntVehicleType; ?></td>
                                                <td><?= $sqlfet_listVehicleType['vehicletype_code']; ?></td>
                                                <td><?= $sqlfet_listVehicleType['vehicletype_name']; ?></td>
                                                <td>
                                                    <a href="?id2edit=<?= $sqlfet_listVehicleType['id']; ?>"
                                                    ...
                                                    <a href="./act4VehicleType.php?id2delete=<?= $sqlfet_listVehicleType['id']; ?>"
