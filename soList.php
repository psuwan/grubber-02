                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="example">
                                    ...
                                    $sqlcmd_listSO = "SELECT * FROM tbl_wg4sell WHERE 1 GROUP BY wg_sonum ORDER BY wg_sonum DESC";
                                            ...
                                            <tr>
                                                <td class="text-center"><?php
                                                    if ($sqlfet_listSO['so_status'] == 0)
                                                        echo "<a href=\"./process4PO.php?command=toggleStatus&returnPage=" . $thisFile . ".php&poNumber=" . $sqlfet_listSO['wg_sonum'] . "\"><i class=\"now-ui-icons media-1_button-power text-danger\"></i></a>";
                                                    else
                                                        echo "<a href=\"./process4PO.php?command=toggleStatus&returnPage=" . $thisFile . ".php&poNumber=" . $sqlfet_listSO['wg_sonum'] . "\"><i class=\"now-ui-icons media-1_button-power text-success\"></i></a>";
                                                    ?>
                                                </td>
                                                ...
                                                <td>ชั่ง<?= getValue("tbl_products", "product_code", $sqlfet_listSO["wg_code4product"], 2, "product_name"); ?></td>
                                                <td><?= monthThai(dateBE(substr($sqlfet_listSO['wg_created'], 0, 10))); ?>
                                                    &nbsp;<?= substr($sqlfet_listSO['wg_created'], 11); ?></td>
                                                <td><?= $sqlfet_listSO['wg_net']; ?></td>
                                                <td>ลงยาง</td>
                                                <td>น้ำหนักลง</td>
                                                <td>ลูกค้า</td>
                                                <td>
                                                    <!-- CALCULATION FOR WEIGHT 2 TIME poMgr -> poMgrAll-->
                                                    <a href="./soMgrAll.php?soNumber=<?= $sqlfet_listSO['wg_sonum']; ?>"
                                                    ...
                                                    <a href="./process4PO.php?command=deletePO&returnPage=<?= $thisFile; ?>.php&soNumber=<?= $sqlfet_listSO['wg_sonum']; ?>"
                                                       data-toggle="tooltip" data-placement="top"
                                                       title="ลบข้อมูล PO"
