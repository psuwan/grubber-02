...
<div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
        ...
        <div class="panel-header h-auto d-flex justify-content-center">
            <h2 class="text-warning font-weight-bold">ตรวจสอบสินค้า</h2>
        </div><!-- Header section -->
                ...
                <div class="col-md-8 order-1 order-md-0">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title"> ตรวจสอบสินค้าคงเหลือ </h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    if ($sqlres_chkStock) {
                                        while ($sqlfet_chkStock = mysqli_fetch_assoc($sqlres_chkStock)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?= getLastRecord("tbl_stocks", "stock_product", $sqlfet_chkStock['stock_product'], "stock_updated", "stock_weight"); ?>
                                                </td>
                                                <td>
...
<script>
    ...
    $("#id4SubMenuBackendStock").addClass("active");
