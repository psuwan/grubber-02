...
<head>
    ...
    <link rel="icon" type="image/png" href="../theme-now-ui-dashboard/assets/img/favicon.png">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>

    <title>goldrubber:จัดซื้อ</title>
    ...
    <link href="../theme-now-ui-dashboard/assets/css/now-ui-dashboard.min.css" rel="stylesheet"/>
...
<script src="../theme-now-ui-dashboard/assets/js/now-ui-dashboard.min.js" type="text/javascript"></script>
