                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h4 class="card-title"> ชั่งขึ้นรถ </h4>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 pr-md-1">
                                        <div class="form-check form-check-radio form-check-inline">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="chkNewSO"
                                                       id="id4_chkNewSO1" value="1">มาใหม่
                                        ...
                                        <div class="form-check form-check-radio form-check-inline">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="chkNewSO"
                                                       id="id4_chkNewSO2" value="2">ขึ้นชั่งแล้ว
                                                <span class="form-check-sign"></span>
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-2 pl-md-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                   placeholder="ชั่งเพื่อส่งแล้ว" name="" id="" disabled value=""
                                                   style="font-size:14px;font-weight:bold;">
                                        </div>
                                    </div>
