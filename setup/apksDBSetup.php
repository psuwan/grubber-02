...
$db_host = confParam('lib', 'apksDBConf.json', 'db_host');
$db_user = confParam('lib', 'apksDBConf.json', 'db_user');
$db_pass = confParam('lib', 'apksDBConf.json', 'db_pass');
$db_name = confParam('lib', 'apksDBConf.json', 'db_name');
$db_char = confParam('lib', 'apksDBConf.json', 'db_char');
$db_port = confParam('lib', 'apksDBConf.json', 'db_port');
...
if (!empty($varpost_processName)) {
    ...
    // Save the file.
    file_put_contents('../lib/apksDBConf.json', $json);
